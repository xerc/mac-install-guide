...
When this was written, Ruby 3.0.2 was the newest version (3.0.0 was released on Dec 25, 2020).
...
For the current shell session, you can switch Ruby versions from the command line with `asdf shell ruby 2.7.3`. Opening the terminal will always use the default version of Ruby you specified initially with `asdf global ruby 3.0.2`.
