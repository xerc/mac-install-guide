...
Here are instructions for installing Ruby using asdf, the software version manager. First, be sure you've completed the section, [Asdf Software Version Manager](/ruby/4.html). (If you are not using asdf, I have are instructions to install Ruby with [chruby](/ruby/11.html) or [Homebrew](/ruby/12.html).)
