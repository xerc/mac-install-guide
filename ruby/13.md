...
Ruby 3.1.0 is the Ruby latest version (released Dec 25, 2021). As of Jan 1, 2022, Homebrew installed Ruby 3.0.3. For the latest Ruby 3.1 version use Homebrew to install a version manager and [Install Ruby with Frum](/ruby/14.html) or [Install Ruby with Asdf](/ruby/6.html).
...
When this was written, Ruby 3.1.0 was the newest version (released on Dec 25, 2021).
