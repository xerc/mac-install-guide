...
It's best to use the newest macOS version. The latest release is macOS Big Sur 11.4 (Big Sur was released on November 12, 2020). If you have an older Mac, Big Sur will run slowly, so you might want to use macOS Catalina.
