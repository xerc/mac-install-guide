...
How to **install Homebrew** for Mac M1 or Mac Intel. Covers installing Homebrew on macOS Monterey. Up-to-date and kitchen-tested instructions, with explanations, from the author of the book, _[Learn Ruby on Rails](https://learn-rails.com/)_, for setting up Homebrew on a Mac.
