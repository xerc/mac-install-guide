  ...
  render(){
    ...
    <nav class="navbar is-transparent is-info" role="navigation" aria-label="main navigation">
      <div class="navbar-brand">
        ...
        <a class="navbar-item" target="blank" href="https://github.com/InstallGuides/mac-install-guide">
      ...
      <div id="navMenu" class="navbar-menu has-background-info">
        <div class="navbar-end">
          ...
          <a itemprop="url" class="navbar-item has-text-white" href="/commandlinetools/index.html">
            <span itemprop="name">Xcode CLT</span></a>
