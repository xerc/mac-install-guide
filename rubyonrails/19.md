...
If you are a casual user and won't be using Ruby frequently, you can use Homebrew to install Ruby. See the section, [Install Ruby with Homebrew](/install-rails-mac/20.html). Most developers should install a software version manager before installing Ruby. It will help you manage multiple versions of Ruby. I recommend [asdf](https://asdf-vm.com/). Asdf can manage versions of many languages, including Ruby and Node. Instructions for asdf are in the section, [Asdf Version Manager](/install-rails-mac/5.html).
...
![](/assets/images/install-rails-mac/install-chruby.png)
...
![](/assets/images/install-rails-mac/add-chruby-to-zshrc.png)
...
![](/assets/images/install-rails-mac/verify-chruby-installation.png)
...
![](/assets/images/install-rails-mac/macos-ruby-install.png)
...
![](/assets/images/install-rails-mac/ruby-install-complete.png)
...
The [Tips: Removing Ruby](/install-rails-mac/15.html) section explains where Ruby versions are installed and how to remove them.

Next, you can optimize the Ruby development environment by updating gems. See the [Update Gems](/install-rails-mac/8.html) section.
