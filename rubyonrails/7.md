...
Here are instructions for installing Ruby using asdf, the software version manager. If you are not using asdf, you can see instructions for [Install Ruby with chruby](/rubyonrails/19.html) or [Install Ruby with Homebrew](/ruby/13.html).
